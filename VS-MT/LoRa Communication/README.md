...
In this folder, all documentation and scripts related to LoRa communication of the NEON multi-turn Valve Sensor can be found.
...
| ----------------------------------------------- | ----------------------------------------------------- |
| Protocol version                                | 2                                                     |
| NEON Configurator                               | [link](https://neon-configurator.twtg.io/neon/mt/v2/) |
