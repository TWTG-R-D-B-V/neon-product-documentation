...
Bytestring (hexidecimal):
```
2604010002000103000702040008030500090406000a7194
```
...
```
{
    ...
    "boot": {
        "device_type": "tt",
        "version_hash": "11223344",
        "device_config_crc": "0001",
        "application_config_crc": "0002",
        "reset_flags": 3,
        "reboot_counter": 4,
...
```
{
    ...
    "device_status": {
        "device_config_crc": "ABCD",
        "application_config_crc": "1234",
        "event_counter": 3,
        "battery_voltage": {
            "low": 0.011,
            "high": 0.012,
...
```
{
    ...
    "device_status": {
        "device_config_crc": "1234",
        "application_config_crc": "ABCD",
        "event_counter": 255,
        "battery_voltage": {
            "low": 4,
            "high": 3.6,
